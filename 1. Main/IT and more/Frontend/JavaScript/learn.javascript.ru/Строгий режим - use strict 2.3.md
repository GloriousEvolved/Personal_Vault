#### [Строгий режим – "use strict" 2.3](https://learn.javascript.ru/strict-mode)
...
>[!warning] Убедитесь, что «use strict» находится в начале
>
...
>[!warning] Нет никакого способа отменить `use strict`
